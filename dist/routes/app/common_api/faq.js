...
router.post('/add', authValidator_1.verifyAuthToken, (0, schemaValidator_1.schemaValidator)(faq_2.addFaq), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.put('/edit', authValidator_1.verifyAuthToken, (0, schemaValidator_1.schemaValidator)(faq_2.editFaq), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield faq_1.default.editFaq(req.body);
    return res.status(CREATED).json({ data, code: CREATED, message: _constants_1.success.en.success });
}));
router.get('/get', authValidator_1.verifyAuthToken, (0, schemaValidator_1.schemaValidator1)(faq_2.getDetails), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
router.get('/list', authValidator_1.verifyAuthToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield faq_1.default.list(req.query);
    return res.status(OK).json({ data, code: OK, message: _constants_1.success.en.recordFetched });
}));
router.delete('/delete', authValidator_1.verifyAuthToken, (0, schemaValidator_1.schemaValidator1)(faq_2.getDetails), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
