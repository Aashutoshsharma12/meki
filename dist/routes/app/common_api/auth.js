 ...
 * User SignUp
 */
router.post(exports.p.signUp, (0, schemaValidator_1.schemaValidator)(auth_2.signUpSchema), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.post(exports.p.check, (0, schemaValidator_1.schemaValidator)(auth_2.accountVerificationSchema), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * User Login
 */
router.post(exports.p.login, (0, schemaValidator_1.schemaValidator)(auth_2.logInSchema), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
