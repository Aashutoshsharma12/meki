    ...
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (users) {
                ...
                if (role == "user") {
                    var topic = [_constants_1.topics.All, _constants_1.topics['All Customers'], _constants_1.topics['All Customers & Business Owners'], _constants_1.topics['All Customers & Delivery Persons']];
                }
                if (role == 'vendor') {
                    var topic = [_constants_1.topics.All, _constants_1.topics['All Business Owners'], _constants_1.topics['All Customers & Business Owners'], _constants_1.topics['All Delivery Persons & Business Owners']];
                }
                (0, helpers_1.subscribeTo_topic)(devicetoken, topic);
