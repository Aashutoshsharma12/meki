...
function deliveryBoyLogin(body, headers, deviceip) {
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (role == 'delivery') {
                var topic = [_constants_1.topics.All, _constants_1.topics['All Delivery Persons'], _constants_1.topics['All Customers & Delivery Persons'], _constants_1.topics['All Delivery Persons & Business Owners']];
            }
