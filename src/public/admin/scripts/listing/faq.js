...
function edit(faqId) {
    $.ajax({
        ...
        // If successful
        document.getElementById('question').value = data.data.question ? data.data.question : "N/A",
            document.getElementById('messo_question').value = data.data.messo_question ? data.data.messo_question : "N/A",
            document.getElementById('answer').value = data.data.answer ? data.data.answer : data.data.answer;
        document.getElementById('faqId').value = data.data._id
        document.getElementById('messo_answer').value = data.data.messo_answer ? data.data.messo_answer : data.data.messo_answer
